<template>
  <div class="agent-container">
    <div class="agent-content-inner">
      <clientOnly>
        <div class="left-history" :style="{ width: leftWidth }" v-if="drawerVisible">
          <!-- 历史会话按钮（放置在左上角） -->
          <HistorySidebar
            :sessions="sessions"
      ...
      <div class="right-chat" :style="rightPanelStyle">
        <ChatArea v-model:messages="messages" @clear="handleClearMessages" v-model:drawerVisible="drawerVisible" />
      </div>
    </div>
  </div>
</template>
