...
export const hasPermi = createPermissionDirective((store, value) => store.checkPermi(value));

/** v-hasRole：按角色权限串校验（如 ['admin']） */
export const hasRole = createPermissionDirective((store, value) => store.checkRole(value));
